package com.finacleproxy.accounts.controller;
...
import com.finacleproxy.accounts.dto.ErrorResponseDto;
import com.finacleproxy.accounts.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Accounts in EazyBytes",
        description = "CRUD REST APIs for Accounts in eazyBytes to CREATE, UPDATE, FETCH and DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    public ResponseEntity<ResponseDto> createAccount(@Valid @RequestBody CustomerDto customerDto) {
        //The CustomerDto class is similar to POJO class
